...
\begin{tikzpicture}[>=triangle 60]
    ...
    \draw[->] (AQ) to[out=180,in=180] (A);
    \draw[->] (Ain) to[out=180,in=180] (A);
    \draw[->] (A) to[out=0, in=0] (Aout);
    \draw[->] (A) to[out=0, in=0] (AQ);
    
    \draw[->] (BQ) to[out=180,in=180] (B);
    \draw[->] (Bin) to[out=180,in=180] (B);
    \draw[->] (B) to[out=0, in=0] (Bout);
    \draw[->] (B) to[out=0, in=0] (BQ);
\end{tikzpicture}
\end{document}
